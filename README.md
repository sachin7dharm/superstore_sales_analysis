...
This project is an interactive Power BI Sales Dashboard created using the Superstore dataset. The dashboard provides business insights related to sales, profit, discounts, customer segments, categories, and regional performance.
